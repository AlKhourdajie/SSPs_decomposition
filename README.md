...
Details on data preparation and downselection are available in folder *01_input_data_prep* above. The folder also includes the code for generating *Figure B.1* and *Table B.3*, Appendix B in the paper.
